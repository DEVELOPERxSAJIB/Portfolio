...
const AboutPage = () => {
  ...
  return (
    <div className="h-auto md:my-20 text-white overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%] sm-mt-0">
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              Passionate Software Developer with 3+ years of experience in web development. Skilled in designing and building dynamic applications. Strong expertise in full-stack development, especially with the MERN stack. Committed to writing clean, efficient, and scalable code.
            </p>
